...
if ( isset( $option ) && isset( $name ) && isset( $quantity_min ) && isset( $quantity_max ) && isset( $current_product ) && isset( $operation_mode ) ) {
	...
	if ( $allow_quantity ) {
		...
		echo '<div class="quantity tm-quantity-vertical' . esc_attr( $quantity_class ) . '">';

do_action(
    'wc_epo_before_product_quantity_input_field',
    $operation_mode,
    $input_value,
    $min_value,
    $max_value
...
/* UP button */
echo '<button type="button" class="tm-qty-btn tm-qty-up" aria-label="Increase quantity">+</button>';
...
/* DOWN button */
echo '<button type="button" class="tm-qty-btn tm-qty-down" aria-label="Decrease quantity">-</button>';

do_action(
    'wc_epo_after_product_quantity_input_field',
    $operation_mode,
    $input_value,
    $min_value,
    $max_value
