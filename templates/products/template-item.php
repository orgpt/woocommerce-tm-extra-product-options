...
<div class="tc-epo-element-product-container<?php echo esc_attr( $container_class ); ?>" data-product_type="<?php echo esc_attr( themecomplete_get_product_type( $current_product ) ); ?>" data-product_variations="<?php echo esc_attr( $product_list_available_variations[ $product_id ] ); ?>" data-product_id="<?php echo esc_attr( $product_id ); ?>">
	...
	<div class="<?php echo esc_attr( ( $show_image ) ? 'tc-epo-element-product-container-right tcwidth tcwidth-70' : 'tc-epo-element-product-container-full tcwidth tcwidth-100' ); ?>">
		<div class="tc-epo-element-product-container-cart" data-per_product_pricing="<?php echo esc_attr( $priced_individually ); ?>">
			<?php
			if ( $show_title ) {
				echo '<h4 class="product-title" style="color: #f79923;"> <span style="margin-left: 10px;"><svg width="20px" height="20px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="none" stroke="#f79923" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" transform="matrix(-1, 0, 0, 1, 0, 0)">

<g id="SVGRepo_bgCarrier" stroke-width="0"/>

<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>

<g id="SVGRepo_iconCarrier"> <polyline points="8.25 2.75,2.75 2.75,2.75 13.25,13.25 13.25,13.25 7.75"/> <path d="m13.25 2.75-5.5 5.5m3-6.5h3.5v3.5"/> </g>
